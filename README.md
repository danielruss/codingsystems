...
US SOC 1980   | csv          | [https://danielruss.github.io/codingsystems/soc1980.csv](https://danielruss.github.io/codingsystems/soc1980.csv) | Made by hand years ago Let me know if you find any errors.  All levels|
 &nbsp;        | csv          | [https://danielruss.github.io/codingsystems/soc1980_most_detailed.csv](https://danielruss.github.io/codingsystems/soc1980_most+detailed.csv) | The most detailed code for SOC 1980 is not always a 4-digit unit code.  This is a list of the most detailed codes (AKA leaf, or does not have child nodes)|
